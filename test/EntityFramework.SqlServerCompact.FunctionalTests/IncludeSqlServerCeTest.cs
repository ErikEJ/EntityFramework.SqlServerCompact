...
{
    public class IncludeSqlServerCeTest : IncludeTestBase<NorthwindQuerySqlServerCeFixture>
    {
...
ORDER BY [c].[CustomerID]",
        ...
        public IncludeSqlServerCeTest(NorthwindQuerySqlServerCeFixture fixture)
            : base(fixture)
        {
        }
