    ...
    public class SqlCeMetadataModelProvider : RelationalMetadataModelProvider
    {
        ...
        public virtual void AddKeysToModel([NotNull] Metadata.Model relationalModel)
        {
            ...
            foreach (var entityType in relationalModel.EntityTypes)
            {
                ...
                {
                    var errorMessage = string.Format("Unable to identify any primary key columns in the underlying SQL Server Compact table [{0}].", 
            ...
            [NotNull] Property property, [NotNull] TableColumn tableColumn)
        {
            ...
            if (tableColumn.DefaultValue != null)
            {
                ...
                else if (defaultExpressionOrValue?.DefaultValue != null)
                {
