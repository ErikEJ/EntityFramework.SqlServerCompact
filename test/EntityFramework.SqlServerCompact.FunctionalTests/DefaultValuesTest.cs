    ...
    public class DefaultValuesTest : IDisposable
    {
        ...
        private class ChipsContext : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder
                    .UseSqlCe(SqlCeTestStore.CreateConnectionString(_databaseName), b => b.ApplyConfiguration())
        ...
        {
            TestStore = SqlCeTestStore.Create("DefaultValuesTest");
        }

        protected SqlCeTestStore TestStore { get; }
