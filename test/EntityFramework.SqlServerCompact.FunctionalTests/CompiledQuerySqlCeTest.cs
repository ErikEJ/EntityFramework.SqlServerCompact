...
{
    public class CompiledQuerySqlCeTest : CompiledQueryTestBase<NorthwindQuerySqlCeFixture>
    {
        public CompiledQuerySqlCeTest(NorthwindQuerySqlCeFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
