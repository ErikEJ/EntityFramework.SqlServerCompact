...
{
    public class QuerySqlCeTestOld : QueryTestBase<NorthwindQuerySqlCeFixture>
    {
        public QuerySqlCeTestOld(NorthwindQuerySqlCeFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
