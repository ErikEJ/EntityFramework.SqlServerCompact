...
namespace Microsoft.EntityFrameworkCore.Query
{
    public class InheritanceRelationshipsQuerySqlCeTest
        : InheritanceRelationshipsQueryTestBase<InheritanceRelationshipsQuerySqlCeFixture>
    {
        public InheritanceRelationshipsQuerySqlCeTest(InheritanceRelationshipsQuerySqlCeFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
