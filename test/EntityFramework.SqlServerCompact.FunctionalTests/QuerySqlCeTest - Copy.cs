...
{
    public class OldQuerySqlCeTest : QueryTestBase<NorthwindQuerySqlCeFixture>
    {
        public OldQuerySqlCeTest(NorthwindQuerySqlCeFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
