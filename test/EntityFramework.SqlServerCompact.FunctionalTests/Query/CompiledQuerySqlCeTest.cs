...
{
    public class CompiledQuerySqlCeTest : CompiledQueryTestBase<NorthwindQuerySqlCeFixture<NoopModelCustomizer>>
    {
        public CompiledQuerySqlCeTest(NorthwindQuerySqlCeFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
