...
{
    public class ComplexNavigationsOwnedQuerySqlCeTest
        : ComplexNavigationsOwnedQueryTestBase<SqlCeTestStore, ComplexNavigationsOwnedQuerySqlCeFixture>
    {
        public ComplexNavigationsOwnedQuerySqlCeTest(
            ComplexNavigationsOwnedQuerySqlCeFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
