...
{
    public class FiltersSqlCeTest : FiltersTestBase<NorthwindQuerySqlCeFixture>
    {
        public FiltersSqlCeTest(NorthwindQuerySqlCeFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
