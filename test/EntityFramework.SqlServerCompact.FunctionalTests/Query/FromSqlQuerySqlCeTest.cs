...
{
    public class FromSqlQuerySqlCeTest : FromSqlQueryTestBase<NorthwindQuerySqlCeFixture<NoopModelCustomizer>>
    {
        public FromSqlQuerySqlCeTest(NorthwindQuerySqlCeFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
...
WHERE [c].[CustomerID] = [o].[CustomerID]",
        ...
        public override void From_sql_queryable_multiple_composed_with_closure_parameters()
        {
            ...
            Assert.Equal(
                @"@__8__locals1_startDate_1='1997-01-01T00:00:00' (DbType = DateTime)
@__8__locals1_endDate_2='1998-01-01T00:00:00' (DbType = DateTime)
...
WHERE [c].[CustomerID] = [o].[CustomerID]",
                //
                @"@p0='Berlin' (Size = 4000)
@__8__locals1_startDate_1='1998-04-01T00:00:00' (DbType = DateTime)
@__8__locals1_endDate_2='1998-05-01T00:00:00' (DbType = DateTime)
