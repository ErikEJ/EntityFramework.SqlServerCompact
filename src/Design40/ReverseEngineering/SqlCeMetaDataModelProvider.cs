...
{
    public class SqlCeMetadataModelProvider : IDatabaseMetadataModelProvider
    {
        private static readonly List<string> DataTypesForNumericPrecisionAndScale = new List<string> { "decimal", "numeric" };

        public const string AnnotationPrefix = "SqlCeMetadataModelProvider:";
        ...
        public SqlCeMetadataModelProvider([NotNull] IServiceProvider serviceProvider)
        {
        ...
        public virtual string DbContextTemplate
        {
            get
            {
                return ReadFromResource(
                    typeof(SqlCeMetadataModelProvider).GetTypeInfo().Assembly,
                    SqlCeDbContextTemplateResourceName);
            }
        }
        ...
        public virtual string EntityTypeTemplate
        {
            get
            {
                return ReadFromResource(
                    typeof(SqlCeMetadataModelProvider).GetTypeInfo().Assembly,
                    SqlCeEntityTypeTemplateResourceName);
            }
        }
        ...
        public virtual Dictionary<string, T> LoadData<T>(
            [NotNull] SqlCeConnection connection,
            [NotNull] string query,
            [NotNull] Func<SqlCeDataReader, T> createFromReader,
        ...
        public virtual IModel ConstructRelationalModel()
        {
            ...
            foreach (var tc in _tableColumns.Values)
            {
                ...
                if (!SqlCeTypeMapping._sqlTypeToClrTypeMap.TryGetValue(tc.DataType, out clrPropertyType))
                {
                    _logger.LogWarning(
