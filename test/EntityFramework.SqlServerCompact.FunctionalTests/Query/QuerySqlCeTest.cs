...
{
    public class QuerySqlCeTest : QueryTestBase<NorthwindQuerySqlCeFixture<NoopModelCustomizer>>
    {
        public QuerySqlCeTest(NorthwindQuerySqlCeFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
